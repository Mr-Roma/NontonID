          ...
          children: [
            ...
            Row(
              children: [
                ...
                const Expanded(
                  child: Padding(
                    padding: const EdgeInsets.only(top: 160, right: 40),
                    child: Column(
                      children: [
                        Text(
                          'Fast & Furious 9',
                      ...
                      Container(
                        ...
                        child: const Column(
                          ...
                          children: [
                            ...
                            Text(
                              '143 Min', // Replace with your text rating
                              style: TextStyle(
                                  fontFamily: 'Open',
                                  fontSize: 17,
                                  color: Colors.white,
                      ...
                      Container(
                        ...
                        child: const Column(
                          ...
                          children: [
                            ...
                            Text(
                              '18+', // Replace with your text rating
                              style: TextStyle(
                                  fontFamily: 'Open',
                                  fontSize: 17,
                                  color: Colors.white,
                    ...
                    child: TextButton(
                      ...
                      style: ButtonStyle(
                        backgroundColor: MaterialStateProperty.all<Color>(
                            const Color.fromARGB(255, 105, 86,
